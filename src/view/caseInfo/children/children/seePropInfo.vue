...
export default {
  ...
  methods: {
    cardList () {
      axios.all([axios.post('/users/dictionary/personIdcardType'), axios.post('/users/dictionary/enterpriseIdcardType'), axios.post('/users/dictionary/nationName')]).then(axios.spread((resO, resT, resS) => {
